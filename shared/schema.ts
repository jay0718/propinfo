...
export const propFirms = pgTable("prop_firms", {
  ...
  payoutTime: integer("payout_time"),
  maxDailyDrawdown: integer("max_daily_drawdown"),
  maxTotalDrawdown: integer("max_total_drawdown"),
  minTradingDays: integer("min_trading_days"),
  scalingPlan: boolean("scaling_plan").default(false),
